/**
 */
#ifndef file_read_record_h
#define file_read_record_h
...
class file_read_record : public vaccs_record {
private:
...
public:
   ...
   * @return the object
   */
  file_read_record *add_event_num(vaccs_event_num_t event_num)
  {
   ...
   * @return the object
   */
  file_read_record *add_c_line_num(vaccs_line_num_t c_line_num)
  {
   ...
   * @return the object
   */
  file_read_record *add_c_file_name(const char *c_file_name)
  {
   ...
   * @return the object
   */
  file_read_record *add_file_descriptor(long fd)
  {
    this->fd = fd;
    return this;
  }
   ...
   * @return the object
   */
  file_read_record *add_valid(bool valid)
  {
    this->valid = valid;
    return this;
  }
...
/**
 * Write a file_read record to the analysis file
 *
...
/**
 * Read a file_read record from the analysis file
 *
 * @param fp a file pointer for the analysis file
 * @return a file_read record
 */
  vaccs_record *read(NATIVE_FD fd);

};

#endif /* file_read_record_h */