...
#ifndef sd_unlock_record_h
#define sd_unlock_record_h
...
/**
 * Class: sd_unlock_record
 *
 * A record for sensitive data unlock data
 */
class sd_unlock_record: public vaccs_record {
private:
...
public:
	 ...
	 * @return the object
	 */
	sd_unlock_record *add_event_num(vaccs_event_num_t event_num) {
	 ...
	 * @return the object
	 */
	sd_unlock_record *add_c_line_num(vaccs_line_num_t c_line_num) {
	 ...
	 * @return the object
	 */
	sd_unlock_record *add_c_file_name(const char* c_file_name) {
	 ...
	 * @return the object
	 */
	sd_unlock_record *add_scope(const char* scope) {
	 ...
	 * @return the object
	 */
	sd_unlock_record *add_variable(const char* variable) {
