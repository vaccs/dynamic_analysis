...
public:
	 ...
	 * @return the object
	 */
	return_addr_record *add_dynamic_link(vaccs_address_t dynamic_link) {
	 ...
	 */
	vaccs_address_t get_dynamic_link() {
		return dynamic_link;
	}
	 ...
	 * @return the object
	 */
	return_addr_record *add_return_address(vaccs_address_t return_address) {
	 ...
	 */
	vaccs_address_t get_return_address() {
	 ...
	 * @return the object
	 */
	return_addr_record *add_c_func_name(const char* c_func_name) {
