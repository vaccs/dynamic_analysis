 ...
 * @return a string containg the value stored at the address
 */
string read_struct_value(type_table *ttab, type_record *trec, Generic addr, CONTEXT *ctxt);
 ...
 * @return a string containg the value stored at the address
 */
string read_value(type_table *ttab, type_record *trec, Generic addr, CONTEXT *ctxt);
 ...
 * @return a string containg the value stored at the address
 */
string read_array_value(type_table *ttab, type_record *trec, Generic addr, CONTEXT *ctxt);
...
var_record* get(string str)
{
	return (var_record*)symbol_table::get(str);
}
